...
struct _month year[12] = { { "January", "Jan", 31 }, { "February", "Feb", 28 },
		{ "March", "mar", 31 }, { "April", "Apr", 30 }, { "May", "May", 31 }, {
				"June", "Jun", 30 }, { "July", "Jul", 31 }, { "August", "Aug",
				30 }, { "Semptemper", "Sem", 30 }, { "October", "Otc", 31 }, {
